...
public class Board : MonoBehaviour
{
    ...
    private void HoverPoints(Vector2Int point, int polyominRows, int polyominoColumns, int[,] polyomino)
    {
        for (var r = 0; r < polyominRows; ++r)
        {
    ...
    {
        fullLineRows.Clear();
        for (var c = fromRow; c < toRowExclusive; ++c)
        {
            var isFullLine = true;
            for (var r = 0; r < Size; ++r)
            {
